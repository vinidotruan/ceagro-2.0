...
$router->get("ceagro/back-end/clientes/{cliente}/contas-bancarias", "ContasBancariasController@index");
$router->post("ceagro/back-end/clientes/{cliente}/contas-bancarias", "ContasBancariasController@cadastrar");
